...
String _$profileHash() => r'ef24822ba5c7ed7188072713618bdf70ae1ec0e2';

/// See also [_profile].
@ProviderFor(_profile)
final _profileProvider = AutoDisposeFutureProvider<UserProfile>.internal(
  _profile,
  name: r'_profileProvider',
